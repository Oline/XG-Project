...
$lang['ins_no_server_requirements']	= 'Your server / hosting does not meet the minimum requirements needed to run XG Project.<br /><br />Requirements: <br />- PHP 5.3.0<br />- MySQL 5.0.19';
$lang['ins_already_installed']		= 'XG Project is already installed. Select an option: <br /><br /> - <a href="index.php?page=update">Update</a> <br /> - <a href="index.php?page=migrate">Migrate</a> <br /> - <a href="../">Back to the game</a> <br /><br />In case you do not want to take any action, for safety, we recommend <span style="color:red;text-decoration:underline;">DELETE</span> the install directory.';
$lang['ins_missing_xml_file']		= 'Could not find the config.xml file or the file config.xml.cfg, you must have one of these in order to continue with the installation. Check your application/config directory and the permissions must be set on chmod 0777';
...
$lang['ins_welcome']				= 'Welcome to XG Project!';
$lang['ins_welcome_first_line']		= 'XG Project is one of the best OGame clones. XG Project 3 is the last and most stable package never before developed. As any other version, XG Project receives support from the team known as Xtreme-gameZ, always making sure to get the best quality care and the stability of the release.. XG Project 3 day by day looks forward; growth, stability, flexibility, dynamism, quality and user confidence. We\'re always expecting that XG Project will be better than your expectations.';
$lang['ins_welcome_second_line']	= 'The installation system will guide you through the installation or upgrading from a previous version to the latest. For doubts, problems o queries, do not hesitate to see our <a href="https://xgproject.org/"><em>support and development community</em></a>.';
$lang['ins_welcome_third_line']		= 'XG Project is an OpenSource project, to see the license specifications click over license in the main menu. To start the installation click on the install button or click on the update button to start the upgrade to a newest version.';
...
$lang['ins_chmod_notice']			= 'Before installing change the permissions of application/config/config.php and application/config/config.xml files to "CHMOD 0777"';
...
$lang['ins_write_config_error']		= 'Error writing the config.php file, make sure it is 0777 CHMOD (write permissions) or the file exists';
